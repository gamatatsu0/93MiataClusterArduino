...
//  **** Top Center **** 2
int TurnLeft = 23; // Top Center
int TurnRight = 24; // Top Center
int Ground  ;

//
int HOLD = 25;
int AirBag = 26; // On Tack Gauge
int Retract = 27; // On Tack Gauge


// **** Middle Center **** 7
int ABS = 28; //Middle Center
int Washer = 29; // Middle Center
int Beam = 30; // Middle Center
int Belts = 31; // Middle Center
int Break = 32; // Middle Center
int Charge = 33;  // Middle Center
int Check_Engine = 34; // Middle Center
